...
- R3.0: pure-Rust digital event semantics/reference engine (complete)
- R3.1: XSPICE adapter + parity proofs against the reference engine
- R4: mixed-signal bridges and coordinated transient simulation
- R5: Verilator-backed Verilog/SystemVerilog blocks
